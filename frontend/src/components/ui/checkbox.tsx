...
>(({ className, ...props }, ref) => {
    return (
        <CheckboxPrimitive.Root
            ref={ref}
            className={cn(
                "h-4 w-4 shrink-0 rounded overflow-hidden border border-gray-900 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-gray-900 data-[state=checked]:text-white flex items-center justify-center transition-all duration-200 ease-in-out",
                className || ""
            )
            }
